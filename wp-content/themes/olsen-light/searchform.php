<form action="<?php echo esc_url( home_url( '/' ) ); ?>" class="searchform" method="get" role="search">
	<div>
		...
		<input type="text" placeholder="<?php echo esc_attr_x( 'Search', 'search box placeholder', 'olsen-light' ); ?>" name="s" value="<?php echo esc_attr( get_search_query() != '' ? get_search_query() : '' ); ?>">
